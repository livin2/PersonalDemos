...
@Controller("deleteVipAction")
public class DeleteVipAction extends ActionSupport implements ModelDriven<VipInfoDTO> {
    ...
    public String execute() throws Exception {
        vipUpdateService.deleteVip(vipInfoDTO.getId());
